...
bot = telebot.TeleBot('7412698601:AAFeNJY17X3Hcf-SL_SQX-GWN7DhmxohwJQ')
...
def welcome_start(message):
    ...
    response = f'''❄️Welcome to @RONIT_IN ka Premium DDOS bot, {user_name}! This is high quality DDOS bot. ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss.
...
💥 only @RONIT_IN can access these all commands.
'''
    bot.reply_to(message, response)
